...
class Utils:
    ...
    def calulate_eye_width_to_height_ratio(eye_point, facial_landmarks):
        ...
        center_top = Utils.midpoint(facial_landmarks.part(eye_point[1]), facial_landmarks.part(eye_point[2]))
        ...
        center_bottom = Utils.midpoint(facial_landmarks.part(eye_point[5]), facial_landmarks.part(eye_point[4]))
